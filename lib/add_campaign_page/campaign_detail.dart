...
//       endDates.add(DateTime.now().add(const Duration(days: 7)));
//     }
//   }
...
//                         horizontal: 20,
//                       ),
//                       //child: Image.asset(campaignDetails[index].imagePath),
//                       child: Image.network(campaignDetails[index].imagePath),
//                     ),
//                     ListTile(
//                       title: Text(campaignDetails[index].title),
//                       subtitle: Text(campaignDetails[index].subtitle),
//                       trailing: IconButton(
...
//   const CampaignDetailPage({super.key, this.userId});

//   @override
//   CampaignDetailPageState createState() =>
//       CampaignDetailPageState(userId: userId);
// }

// class CampaignDetailPageState extends State<CampaignDetailPage> {
//   final String? userId;
//   CampaignDetailPageState({this.userId});
//   static List<AdvertisingStructure> campaignDetails =
//       CampaignData().selectedStructures;
//   List<DateTime> startDates = [];
//   List<DateTime> endDates = [];
...
//           'categoryId': campaignDetails[i].categoryId, // Pass category ID
//           'locationId': campaignDetails[i].locationId, // Pass location ID
//           // 'categoryName': campaignDetails[i].title,
//           // 'location': campaignDetails[i].subtitle,
...
//       {super.key, this.userId, this.categoryId, this.locationId});

//   @override
//   CampaignDetailPageState createState() => CampaignDetailPageState(
//       userId: userId, categoryId: categoryId, locationId: locationId);
// }
...
class CampaignDetailPageState extends State<CampaignDetailPage> {
  ...
  //   for (int i = 0; i < campaignDetails.length; i++) {
  //     String? startDate = prefs.getString('startDate_$i');
  //     String? endDate = prefs.getString('endDate_$i');
  //     setState(() {
  //       startDates.add(
  //           startDate != null ? DateTime.parse(startDate) : DateTime.now());
  //       endDates.add(endDate != null
