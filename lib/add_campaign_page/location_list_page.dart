...
//                             imagePath: imagePath,
//                             categoryId: widget
//                                 .categoryId, // Pass the category ID from the widget
...
//               // For example, navigate to a cart page or show a dialog
//               Navigator.push(
//                 context,
//                 MaterialPageRoute(
//                   builder: (context) => CampaignDetailPage(userId: userId),
//                 ),
//               );
//             },
//           ),
...
//                     0; // Ensure locationId is an int
//                 return _buildLocationBox(
//                   context,
//                   widget.categoryName, // Use categoryName as the title
//                   // location["${widget.categoryName} Locations"] ??
//                   //    '', // Provide default empty string
//                   " ${location['location_name'] ?? ''}", // Provide default empty string
//                   location['location_image'] ??
//                       '', // Provide default empty string
//                   locationId, // Pass location ID for details
//                   widget.categoryId,
//                 );
//               },
//             ),
