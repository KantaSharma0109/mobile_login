...
//       try {
//         String uri =
//             "http://192.168.29.202:8080/mobilelogin_api/insert_record.php";
...
//             print("Mobile number inserted successfully");

//             // Check if the response contains the role information
...
//             // If role information is missing, navigate to HomePage
//             Navigator.pushReplacement(
//               context,
//               MaterialPageRoute(builder: (context) => const NavbarPage()),
//             );
//           } else {
//             print("Failed to insert mobile number: ${response['message']}");
//           }
//         } else {
//           print(
//               "Failed to insert mobile number. HTTP Status Code: ${res.statusCode}");
//         }
//       } catch (e) {
//         print("Error inserting mobile number: $e");
//       }
//     } else {
